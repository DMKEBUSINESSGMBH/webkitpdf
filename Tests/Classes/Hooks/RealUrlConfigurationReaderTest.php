...
/**
 * Class RealUrlConfigurationReaderTest.
 *
 * @author  Hannes Bochmann
 * @license http://www.gnu.org/licenses/lgpl.html
 *          GNU Lesser General Public License, version 3 or later
 */
class RealUrlConfigurationReaderTest extends \tx_rnbase_tests_BaseTestCase
{
    protected function setUp()
    {
        if (!\tx_rnbase_util_Extensions::isLoaded('realurl')) {
            self::markTestSkipped('realurl not installed');
        }
    }
     ...
     * @group unit
     */
    public function testAddWebkitpdfToBannedUrlsRegExp()
    {
        $configurationReader = $this->getMock(ConfigurationReader::class, ['dummy'], [], '', false);
