...
final class DMKWebkitpdfCTypeMigration extends AbstractListTypeToCTypeUpdate
{
    ...
    {
        return 'Migrate "DMK Webkitpdf" plugins to content elements.';
    }

    public function getDescription(): string
    {
        return 'The "DMK Webkitpdf" plugins are now registered as content element. Update migrates existing records and backend user permissions.';
    }
